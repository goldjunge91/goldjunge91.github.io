...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Vn,depthTest:!1,depthWrite:!1})}function Dl(){return new Mi({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:io(),fragmentShader:`
		...
		`,blending:Vn,depthTest:!1,depthWrite:!1})}function Ul(){return new Mi({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:io(),fragmentShader:`
...
`].filter(gr).join(`
`)),a=Ua(a),a=Hl(a,e),a=Vl(a,e),o=Ua(o),o=Hl(o,e),o=Vl(o,e),a=Wl(a),o=Wl(o),e.isWebGL2&&e.isRawShaderMaterial!==!0&&(S=`#version 300 es
 ...
 * Subject to the terms at https://gsap.com/standard-license
 * @author: Jack Doyle, jack@greensock.com
*/var oc,kn,Yi,So,ui,lc,Eo,y0=function(){return typeof window<"u"},Un={},li=180/Math.PI,ji=Math.PI/180,zi=Math.atan2,cc=1e8,yo=/([A-Z])/g,T0=/(left|right|width|margin|padding|x)/i,b0=/[\s,\(]\S/,dn={autoAlpha:"opacity,visibility",scale:"scaleX,scaleY",alpha:"opacity"},qa=function(t,e){return e.set(e.t,e.p,Math.round((e.s+e.c*t)*1e4)/1e4+e.u,e)},A0=function(t,e){return e.set(e.t,e.p,t===1?e.e:Math.round((e.s+e.c*t)*1e4)/1e4+e.u,e)},w0=function(t,e){return e.set(e.t,e.p,t?Math.round((e.s+e.c*t)*1e4)/1e4+e.u:e.b,e)},R0=function(t,e){var n=e.s+e.c*t;e.set(e.t,e.p,~~(n+(n<0?-.5:.5))+e.u,e)},Gu=function(t,e){return e.set(e.t,e.p,t?e.e:e.b,e)},ku=function(t,e){return e.set(e.t,e.p,t!==1?e.b:e.e,e)},C0=function(t,e,n){return t.style[e]=n},P0=function(t,e,n){return t.style.setProperty(e,n)},L0=function(t,e,n){return t._gsap[e]=n},D0=function(t,e,n){return t._gsap.scaleX=t._gsap.scaleY=n},U0=function(t,e,n,i,s){var a=t._gsap;a.scaleX=a.scaleY=n,a.renderTransform(s,a)},I0=function(t,e,n,i,s){var a=t._gsap;a[e]=n,a.renderTransform(s,a)},Zt="transform",Ne=Zt+"Origin",N0=function r(t,e){var n=this,i=this.target,s=i.style,a=i._gsap;if(t in Un&&s){if(this.tfm=this.tfm||{},t!=="transform")t=dn[t]||t,~t.indexOf(",")?t.split(",").forEach(function(o){return n.tfm[o]=wn(i,o)}):this.tfm[t]=a.x?a[t]:wn(i,t),t===Ne&&(this.tfm.zOrigin=a.zOrigin);else return dn.transform.split(",").forEach(function(o){return r.call(n,o,e)});if(this.props.indexOf(Zt)>=0)return;a.svg&&(this.svgo=i.getAttribute("data-svg-origin"),this.props.push(Ne,e,"")),t=Zt}(s||e)&&this.props.push(t,e,s[t])},Hu=function(t){t.translate&&(t.removeProperty("translate"),t.removeProperty("scale"),t.removeProperty("rotate"))},F0=function(){var t=this.props,e=this.target,n=e.style,i=e._gsap,s,a;for(s=0;s<t.length;s+=3)t[s+1]?t[s+1]===2?e[t[s]](t[s+2]):e[t[s]]=t[s+2]:t[s+2]?n[t[s]]=t[s+2]:n.removeProperty(t[s].substr(0,2)==="--"?t[s]:t[s].replace(yo,"-$1").toLowerCase());if(this.tfm){for(a in this.tfm)i[a]=this.tfm[a];i.svg&&(i.renderTransform(),e.setAttribute("data-svg-origin",this.svgo||"")),s=Eo(),(!s||!s.isStart)&&!n[Zt]&&(Hu(n),i.zOrigin&&n[Ne]&&(n[Ne]+=" "+i.zOrigin+"px",i.zOrigin=0,i.renderTransform()),i.uncache=1)}},Vu=function(t,e){var n={target:t,props:[],revert:F0,save:N0};return t._gsap||Fe.core.getCache(t),e&&t.style&&t.nodeType&&e.split(",").forEach(function(i){return n.save(i)}),n},Wu,Ya=function(t,e){var n=kn.createElementNS?kn.createElementNS((e||"http://www.w3.org/1999/xhtml").replace(/^https/,"http"),t):kn.createElement(t);return n&&n.style?n:kn.createElement(t)},Je=function r(t,e,n){var i=getComputedStyle(t);return i[e]||i.getPropertyValue(e.replace(yo,"-$1").toLowerCase())||i.getPropertyValue(e)||!n&&r(t,rr(e)||e,1)||""},uc="O,Moz,ms,Ms,Webkit".split(","),rr=function(t,e,n){var i=e||ui,s=i.style,a=5;if(t in s&&!n)return t;for(t=t.charAt(0).toUpperCase()+t.substr(1);a--&&!(uc[a]+t in s););return a<0?null:(a===3?"ms":a>=0?uc[a]:"")+t},ja=function(){y0()&&window.document&&(oc=window,kn=oc.document,Yi=kn.documentElement,ui=Ya("div")||{style:{}},Ya("div"),Zt=rr(Zt),Ne=Zt+"Origin",ui.style.cssText="border-width:0;line-height:0;position:absolute;padding:0",Wu=!!rr("perspective"),Eo=Fe.core.reverting,So=1)},hc=function(t){var e=t.ownerSVGElement,n=Ya("svg",e&&e.getAttribute("xmlns")||"http://www.w3.org/2000/svg"),i=t.cloneNode(!0),s;i.style.display="block",n.appendChild(i),Yi.appendChild(n);try{s=i.getBBox()}catch{}return n.removeChild(i),Yi.removeChild(n),s},fc=function(t,e){for(var n=e.length;n--;)if(t.hasAttribute(e[n]))return t.getAttribute(e[n])},Xu=function(t){var e,n;try{e=t.getBBox()}catch{e=hc(t),n=1}return e&&(e.width||e.height)||n||(e=hc(t)),e&&!e.width&&!e.x&&!e.y?{x:+fc(t,["x","cx","x1"])||0,y:+fc(t,["y","cy","y1"])||0,width:0,height:0}:e},qu=function(t){return!!(t.getCTM&&(!t.parentNode||t.ownerSVGElement)&&Xu(t))},Si=function(t,e){if(e){var n=t.style,i;e in Un&&e!==Ne&&(e=Zt),n.removeProperty?(i=e.substr(0,2),(i==="ms"||e.substr(0,6)==="webkit")&&(e="-"+e),n.removeProperty(i==="--"?e:e.replace(yo,"-$1").toLowerCase())):n.removeAttribute(e)}},Hn=function(t,e,n,i,s,a){var o=new Ie(t._pt,e,n,0,1,a?ku:Gu);return t._pt=o,o.b=i,o.e=s,t._props.push(n),o},dc={deg:1,rad:1,turn:1},O0={grid:1,flex:1},Kn=function r(t,e,n,i){var s=parseFloat(n)||0,a=(n+"").trim().substr((s+"").length)||"px",o=ui.style,l=T0.test(e),c=t.tagName.toLowerCase()==="svg",u=(c?"client":"offset")+(l?"Width":"Height"),h=100,f=i==="px",m=i==="%",g,_,p,d;if(i===a||!s||dc[i]||dc[a])return s;if(a!=="px"&&!f&&(s=r(t,e,n,"px")),d=t.getCTM&&qu(t),(m||a==="%")&&(Un[e]||~e.indexOf("adius")))return g=d?t.getBBox()[l?"width":"height"]:t[u],ee(m?s/g*h:s/100*g);if(o[l?"width":"height"]=h+(f?a:i),_=i!=="rem"&&~e.indexOf("adius")||i==="em"&&t.appendChild&&!c?t:t.parentNode,d&&(_=(t.ownerSVGElement||{}).parentNode),(!_||_===kn||!_.appendChild)&&(_=kn.body),p=_._gsap,p&&m&&p.width&&l&&p.time===ke.time&&!p.uncache)return ee(s/p.width*h);if(m&&(e==="height"||e==="width")){var S=t.style[e];t.style[e]=h+i,g=t[u],S?t.style[e]=S:Si(t,e)}else(m||a==="%")&&!O0[Je(_,"display")]&&(o.position=Je(t,"position")),_===t&&(o.position="static"),_.appendChild(ui),g=ui[u],_.removeChild(ui),o.position="absolute";return l&&m&&(p=mi(_),p.time=ke.time,p.width=_[u]),ee(f?g*s/h:g&&s?h/g*s:0)},wn=function(t,e,n,i){var s;return So||ja(),e in dn&&e!=="transform"&&(e=dn[e],~e.indexOf(",")&&(e=e.split(",")[0])),Un[e]&&e!=="transform"?(s=Nr(t,i),s=e!=="transformOrigin"?s[e]:s.svg?s.origin:bs(Je(t,Ne))+" "+s.zOrigin+"px"):(s=t.style[e],(!s||s==="auto"||i||~(s+"").indexOf("calc("))&&(s=Ts[e]&&Ts[e](t,e,n)||Je(t,e)||lu(t,e)||(e==="opacity"?1:0))),n&&!~(s+"").trim().indexOf(" ")?Kn(t,e,s,n)+n:s},B0=function(t,e,n,i){if(!n||n==="none"){var s=rr(e,t,1),a=s&&Je(t,s,1);a&&a!==n?(e=s,n=a):e==="borderColor"&&(n=Je(t,"borderTopColor"))}var o=new Ie(this._pt,t.style,e,0,1,Ou),l=0,c=0,u,h,f,m,g,_,p,d,S,x,M,E;if(o.b=n,o.e=i,n+="",i+="",i.substring(0,6)==="var(--"&&(i=Je(t,i.substring(4,i.indexOf(")")))),i==="auto"&&(_=t.style[e],t.style[e]=i,i=Je(t,e)||i,_?t.style[e]=_:Si(t,e)),u=[n,i],wu(u),n=u[0],i=u[1],f=n.match(Hi)||[],E=i.match(Hi)||[],E.length){for(;h=Hi.exec(i);)p=h[0],S=i.substring(l,h.index),g?g=(g+1)%5:(S.substr(-5)==="rgba("||S.substr(-5)==="hsla(")&&(g=1),p!==(_=f[c++]||"")&&(m=parseFloat(_)||0,M=_.substr((m+"").length),p.charAt(1)==="="&&(p=qi(m,p)+M),d=parseFloat(p),x=p.substr((d+"").length),l=Hi.lastIndex-x.length,x||(x=x||We.units[e]||M,l===i.length&&(i+=x,o.e+=x)),M!==x&&(m=Kn(t,e,_,x)||0),o._pt={_next:o._pt,p:S||c===1?S:",",s:m,c:d-m,m:g&&g<4||e==="zIndex"?Math.round:0});o.c=l<i.length?i.substring(l,i.length):""}else o.r=e==="display"&&i==="none"?ku:Gu;return nu.test(i)&&(o.e=0),this._pt=o,o},pc={top:"0%",bottom:"100%",left:"0%",right:"100%",center:"50%"},z0=function(t){var e=t.split(" "),n=e[0],i=e[1]||"50%";return(n==="top"||n==="bottom"||i==="left"||i==="right")&&(t=n,n=i,i=t),e[0]=pc[n]||n,e[1]=pc[i]||i,e.join(" ")},G0=function(t,e){if(e.tween&&e.tween._time===e.tween._dur){var n=e.t,i=n.style,s=e.u,a=n._gsap,o,l,c;if(s==="all"||s===!0)i.cssText="",l=1;else for(s=s.split(","),c=s.length;--c>-1;)o=s[c],Un[o]&&(l=1,o=o==="transformOrigin"?Ne:Zt),Si(n,o);l&&(Si(n,Zt),a&&(a.svg&&n.removeAttribute("transform"),i.scale=i.rotate=i.translate="none",Nr(n,1),a.uncache=1,Hu(i)))}},Ts={clearProps:function(t,e,n,i,s){if(s.data!=="isFromStart"){var a=t._pt=new Ie(t._pt,e,n,0,0,G0);return a.u=i,a.pr=-10,a.tween=s,t._props.push(n),1}}},Ir=[1,0,0,1,0,0],Yu={},ju=function(t){return t==="matrix(1, 0, 0, 1, 0, 0)"||t==="none"||!t},mc=function(t){var e=Je(t,Zt);return ju(e)?Ir:e.substr(7).match(eu).map(ee)},To=function(t,e){var n=t._gsap||mi(t),i=t.style,s=mc(t),a,o,l,c;return n.svg&&t.getAttribute("transform")?(l=t.transform.baseVal.consolidate().matrix,s=[l.a,l.b,l.c,l.d,l.e,l.f],s.join(",")==="1,0,0,1,0,0"?Ir:s):(s===Ir&&!t.offsetParent&&t!==Yi&&!n.svg&&(l=i.display,i.display="block",a=t.parentNode,(!a||!t.offsetParent&&!t.getBoundingClientRect().width)&&(c=1,o=t.nextElementSibling,Yi.appendChild(t)),s=mc(t),l?i.display=l:Si(t,"display"),c&&(o?a.insertBefore(t,o):a?a.appendChild(t):Yi.removeChild(t))),e&&s.length>6?[s[0],s[1],s[4],s[5],s[12],s[13]]:s)},Ka=function(t,e,n,i,s,a){var o=t._gsap,l=s||To(t,!0),c=o.xOrigin||0,u=o.yOrigin||0,h=o.xOffset||0,f=o.yOffset||0,m=l[0],g=l[1],_=l[2],p=l[3],d=l[4],S=l[5],x=e.split(" "),M=parseFloat(x[0])||0,E=parseFloat(x[1])||0,b,R,C,v;n?l!==Ir&&(R=m*p-g*_)&&(C=M*(p/R)+E*(-_/R)+(_*S-p*d)/R,v=M*(-g/R)+E*(m/R)-(m*S-g*d)/R,M=C,E=v):(b=Xu(t),M=b.x+(~x[0].indexOf("%")?M/100*b.width:M),E=b.y+(~(x[1]||x[0]).indexOf("%")?E/100*b.height:E)),i||i!==!1&&o.smooth?(d=M-c,S=E-u,o.xOffset=h+(d*m+S*_)-d,o.yOffset=f+(d*g+S*p)-S):o.xOffset=o.yOffset=0,o.xOrigin=M,o.yOrigin=E,o.smooth=!!i,o.origin=e,o.originIsAbsolute=!!n,t.style[Ne]="0px 0px",a&&(Hn(a,o,"xOrigin",c,M),Hn(a,o,"yOrigin",u,E),Hn(a,o,"xOffset",h,o.xOffset),Hn(a,o,"yOffset",f,o.yOffset)),t.setAttribute("data-svg-origin",M+" "+E)},Nr=function(t,e){var n=t._gsap||new Lu(t);if("x"in n&&!e&&!n.uncache)return n;var i=t.style,s=n.scaleX<0,a="px",o="deg",l=getComputedStyle(t),c=Je(t,Ne)||"0",u,h,f,m,g,_,p,d,S,x,M,E,b,R,C,v,A,k,Y,L,O,B,j,G,X,J,K,ut,I,$,Z,st;return u=h=f=_=p=d=S=x=M=0,m=g=1,n.svg=!!(t.getCTM&&qu(t)),l.translate&&((l.translate!=="none"||l.scale!=="none"||l.rotate!=="none")&&(i[Zt]=(l.translate!=="none"?"translate3d("+(l.translate+" 0 0").split(" ").slice(0,3).join(", ")+") ":"")+(l.rotate!=="none"?"rotate("+l.rotate+") ":"")+(l.scale!=="none"?"scale("+l.scale.split(" ").join(",")+") ":"")+(l[Zt]!=="none"?l[Zt]:"")),i.scale=i.rotate=i.translate="none"),R=To(t,n.svg),n.svg&&(n.uncache?(X=t.getBBox(),c=n.xOrigin-X.x+"px "+(n.yOrigin-X.y)+"px",G=""):G=!e&&t.getAttribute("data-svg-origin"),Ka(t,G||c,!!G||n.originIsAbsolute,n.smooth!==!1,R)),E=n.xOrigin||0,b=n.yOrigin||0,R!==Ir&&(k=R[0],Y=R[1],L=R[2],O=R[3],u=B=R[4],h=j=R[5],R.length===6?(m=Math.sqrt(k*k+Y*Y),g=Math.sqrt(O*O+L*L),_=k||Y?zi(Y,k)*li:0,S=L||O?zi(L,O)*li+_:0,S&&(g*=Math.abs(Math.cos(S*ji))),n.svg&&(u-=E-(E*k+b*L),h-=b-(E*Y+b*O))):(st=R[6],$=R[7],K=R[8],ut=R[9],I=R[10],Z=R[11],u=R[12],h=R[13],f=R[14],C=zi(st,I),p=C*li,C&&(v=Math.cos(-C),A=Math.sin(-C),G=B*v+K*A,X=j*v+ut*A,J=st*v+I*A,K=B*-A+K*v,ut=j*-A+ut*v,I=st*-A+I*v,Z=$*-A+Z*v,B=G,j=X,st=J),C=zi(-L,I),d=C*li,C&&(v=Math.cos(-C),A=Math.sin(-C),G=k*v-K*A,X=Y*v-ut*A,J=L*v-I*A,Z=O*A+Z*v,k=G,Y=X,L=J),C=zi(Y,k),_=C*li,C&&(v=Math.cos(C),A=Math.sin(C),G=k*v+Y*A,X=B*v+j*A,Y=Y*v-k*A,j=j*v-B*A,k=G,B=X),p&&Math.abs(p)+Math.abs(_)>359.9&&(p=_=0,d=180-d),m=ee(Math.sqrt(k*k+Y*Y+L*L)),g=ee(Math.sqrt(j*j+st*st)),C=zi(B,j),S=Math.abs(C)>2e-4?C*li:0,M=Z?1/(Z<0?-Z:Z):0),n.svg&&(G=t.getAttribute("transform"),n.forceCSS=t.setAttribute("transform","")||!ju(Je(t,Zt)),G&&t.setAttribute("transform",G))),Math.abs(S)>90&&Math.abs(S)<270&&(s?(m*=-1,S+=_<=0?180:-180,_+=_<=0?180:-180):(g*=-1,S+=S<=0?180:-180)),e=e||n.uncache,n.x=u-((n.xPercent=u&&(!e&&n.xPercent||(Math.round(t.offsetWidth/2)===Math.round(-u)?-50:0)))?t.offsetWidth*n.xPercent/100:0)+a,n.y=h-((n.yPercent=h&&(!e&&n.yPercent||(Math.round(t.offsetHeight/2)===Math.round(-h)?-50:0)))?t.offsetHeight*n.yPercent/100:0)+a,n.z=f+a,n.scaleX=ee(m),n.scaleY=ee(g),n.rotation=ee(_)+o,n.rotationX=ee(p)+o,n.rotationY=ee(d)+o,n.skewX=S+o,n.skewY=x+o,n.transformPerspective=M+a,(n.zOrigin=parseFloat(c.split(" ")[2])||!e&&n.zOrigin||0)&&(i[Ne]=bs(c)),n.xOffset=n.yOffset=0,n.force3D=We.force3D,n.renderTransform=n.svg?H0:Wu?Ku:k0,n.uncache=0,n},bs=function(t){return(t=t.split(" "))[0]+" "+t[1]},ba=function(t,e,n){var i=Me(e);return ee(parseFloat(e)+parseFloat(Kn(t,"x",n+"px",i)))+i},k0=function(t,e){e.z="0px",e.rotationY=e.rotationX="0deg",e.force3D=0,Ku(t,e)},ri="0deg",mr="0px",si=") ",Ku=function(t,e){var n=e||this,i=n.xPercent,s=n.yPercent,a=n.x,o=n.y,l=n.z,c=n.rotation,u=n.rotationY,h=n.rotationX,f=n.skewX,m=n.skewY,g=n.scaleX,_=n.scaleY,p=n.transformPerspective,d=n.force3D,S=n.target,x=n.zOrigin,M="",E=d==="auto"&&t&&t!==1||d===!0;if(x&&(h!==ri||u!==ri)){var b=parseFloat(u)*ji,R=Math.sin(b),C=Math.cos(b),v;b=parseFloat(h)*ji,v=Math.cos(b),a=ba(S,a,R*v*-x),o=ba(S,o,-Math.sin(b)*-x),l=ba(S,l,C*v*-x+x)}p!==mr&&(M+="perspective("+p+si),(i||s)&&(M+="translate("+i+"%, "+s+"%) "),(E||a!==mr||o!==mr||l!==mr)&&(M+=l!==mr||E?"translate3d("+a+", "+o+", "+l+") ":"translate("+a+", "+o+si),c!==ri&&(M+="rotate("+c+si),u!==ri&&(M+="rotateY("+u+si),h!==ri&&(M+="rotateX("+h+si),(f!==ri||m!==ri)&&(M+="skew("+f+", "+m+si),(g!==1||_!==1)&&(M+="scale("+g+", "+_+si),S.style[Zt]=M||"translate(0, 0)"},H0=function(t,e){var n=e||this,i=n.xPercent,s=n.yPercent,a=n.x,o=n.y,l=n.rotation,c=n.skewX,u=n.skewY,h=n.scaleX,f=n.scaleY,m=n.target,g=n.xOrigin,_=n.yOrigin,p=n.xOffset,d=n.yOffset,S=n.forceCSS,x=parseFloat(a),M=parseFloat(o),E,b,R,C,v;l=parseFloat(l),c=parseFloat(c),u=parseFloat(u),u&&(u=parseFloat(u),c+=u,l+=u),l||c?(l*=ji,c*=ji,E=Math.cos(l)*h,b=Math.sin(l)*h,R=Math.sin(l-c)*-f,C=Math.cos(l-c)*f,c&&(u*=ji,v=Math.tan(c-u),v=Math.sqrt(1+v*v),R*=v,C*=v,u&&(v=Math.tan(u),v=Math.sqrt(1+v*v),E*=v,b*=v)),E=ee(E),b=ee(b),R=ee(R),C=ee(C)):(E=h,C=f,b=R=0),(x&&!~(a+"").indexOf("px")||M&&!~(o+"").indexOf("px"))&&(x=Kn(m,"x",a,"px"),M=Kn(m,"y",o,"px")),(g||_||p||d)&&(x=ee(x+g-(g*E+_*R)+p),M=ee(M+_-(g*b+_*C)+d)),(i||s)&&(v=m.getBBox(),x=ee(x+i/100*v.width),M=ee(M+s/100*v.height)),v="matrix("+E+","+b+","+R+","+C+","+x+","+M+")",m.setAttribute("transform",v),S&&(m.style[Zt]=v)},V0=function(t,e,n,i,s){var a=360,o=de(s),l=parseFloat(s)*(o&&~s.indexOf("rad")?li:1),c=l-i,u=i+c+"deg",h,f;return o&&(h=s.split("_")[1],h==="short"&&(c%=a,c!==c%(a/2)&&(c+=c<0?a:-a)),h==="cw"&&c<0?c=(c+a*cc)%a-~~(c/a)*a:h==="ccw"&&c>0&&(c=(c-a*cc)%a-~~(c/a)*a)),t._pt=f=new Ie(t._pt,e,n,i,c,A0),f.e=u,f.u="deg",t._props.push(n),f},_c=function(t,e){for(var n in e)t[n]=e[n];return t},W0=function(t,e,n){var i=_c({},n._gsap),s="perspective,force3D,transformOrigin,svgOrigin",a=n.style,o,l,c,u,h,f,m,g;i.svg?(c=n.getAttribute("transform"),n.setAttribute("transform",""),a[Zt]=e,o=Nr(n,1),Si(n,Zt),n.setAttribute("transform",c)):(c=getComputedStyle(n)[Zt],a[Zt]=e,o=Nr(n,1),a[Zt]=c);for(l in Un)c=i[l],u=o[l],c!==u&&s.indexOf(l)<0&&(m=Me(c),g=Me(u),h=m!==g?Kn(n,l,c,g):parseFloat(c),f=parseFloat(u),t._pt=new Ie(t._pt,o,l,h,f-h,qa),t._pt.u=g||0,t._props.push(l));_c(o,i)};Ue("padding,margin,Width,Radius",function(r,t){var e="Top",n="Right",i="Bottom",s="Left",a=(t<3?[e,n,i,s]:[e+s,e+n,i+n,i+s]).map(function(o){return t<2?r+o:"border"+o+r});Ts[t>1?"border"+r:r]=function(o,l,c,u,h){var f,m;if(arguments.length<4)return f=a.map(function(g){return wn(o,g,c)}),m=f.join(" "),m.split(f[0]).length===5?f[0]:m;f=(u+"").split(" "),m={},a.forEach(function(g,_){return m[g]=f[_]=f[_]||f[(_-1)/2|0]}),o.init(l,m,h)}});var Zu={name:"css",register:ja,targetTest:function(t){return t.style&&t.nodeType},init:function(t,e,n,i,s){var a=this._props,o=t.style,l=n.vars.startAt,c,u,h,f,m,g,_,p,d,S,x,M,E,b,R,C;So||ja(),this.styles=this.styles||Vu(t),C=this.styles.props,this.tween=n;for(_ in e)if(_!=="autoRound"&&(u=e[_],!(Ge[_]&&Du(_,e,n,i,t,s)))){if(m=typeof u,g=Ts[_],m==="function"&&(u=u.call(n,i,t,s),m=typeof u),m==="string"&&~u.indexOf("random(")&&(u=Lr(u)),g)g(this,t,_,u,n)&&(R=1);else if(_.substr(0,2)==="--")c=(getComputedStyle(t).getPropertyValue(_)+"").trim(),u+="",qn.lastIndex=0,qn.test(c)||(p=Me(c),d=Me(u)),d?p!==d&&(c=Kn(t,_,c,d)+d):p&&(u+=p),this.add(o,"setProperty",c,u,i,s,0,0,_),a.push(_),C.push(_,0,o[_]);else if(m!=="undefined"){if(l&&_ in l?(c=typeof l[_]=="function"?l[_].call(n,i,t,s):l[_],de(c)&&~c.indexOf("random(")&&(c=Lr(c)),Me(c+"")||c==="auto"||(c+=We.units[_]||Me(wn(t,_))||""),(c+"").charAt(1)==="="&&(c=wn(t,_))):c=wn(t,_),f=parseFloat(c),S=m==="string"&&u.charAt(1)==="="&&u.substr(0,2),S&&(u=u.substr(2)),h=parseFloat(u),_ in dn&&(_==="autoAlpha"&&(f===1&&wn(t,"visibility")==="hidden"&&h&&(f=0),C.push("visibility",0,o.visibility),Hn(this,o,"visibility",f?"inherit":"hidden",h?"inherit":"hidden",!h)),_!=="scale"&&_!=="transform"&&(_=dn[_],~_.indexOf(",")&&(_=_.split(",")[0]))),x=_ in Un,x){if(this.styles.save(_),m==="string"&&u.substring(0,6)==="var(--"&&(u=Je(t,u.substring(4,u.indexOf(")"))),h=parseFloat(u)),M||(E=t._gsap,E.renderTransform&&!e.parseTransform||Nr(t,e.parseTransform),b=e.smoothOrigin!==!1&&E.smooth,M=this._pt=new Ie(this._pt,o,Zt,0,1,E.renderTransform,E,0,-1),M.dep=1),_==="scale")this._pt=new Ie(this._pt,E,"scaleY",E.scaleY,(S?qi(E.scaleY,S+h):h)-E.scaleY||0,qa),this._pt.u=0,a.push("scaleY",_),_+="X";else if(_==="transformOrigin"){C.push(Ne,0,o[Ne]),u=z0(u),E.svg?Ka(t,u,0,b,0,this):(d=parseFloat(u.split(" ")[2])||0,d!==E.zOrigin&&Hn(this,E,"zOrigin",E.zOrigin,d),Hn(this,o,_,bs(c),bs(u)));continue}else if(_==="svgOrigin"){Ka(t,u,1,b,0,this);continue}else if(_ in Yu){V0(this,E,_,f,S?qi(f,S+u):u);continue}else if(_==="smoothOrigin"){Hn(this,E,"smooth",E.smooth,u);continue}else if(_==="force3D"){E[_]=u;continue}else if(_==="transform"){W0(this,u,t);continue}}else _ in o||(_=rr(_)||_);if(x||(h||h===0)&&(f||f===0)&&!b0.test(u)&&_ in o)p=(c+"").substr((f+"").length),h||(h=0),d=Me(u)||(_ in We.units?We.units[_]:p),p!==d&&(f=Kn(t,_,c,d)),this._pt=new Ie(this._pt,x?E:o,_,f,(S?qi(f,S+h):h)-f,!x&&(d==="px"||_==="zIndex")&&e.autoRound!==!1?R0:qa),this._pt.u=d||0,p!==d&&d!=="%"&&(this._pt.b=c,this._pt.r=w0);else if(_ in o)B0.call(this,t,_,c,S?S+u:u);else if(_ in t)this.add(t,_,c||t[_],S?S+u:u,i,s);else if(_!=="parseTransform"){uo(_,u);continue}x||(_ in o?C.push(_,0,o[_]):typeof t[_]=="function"?C.push(_,2,t[_]()):C.push(_,1,c||t[_])),a.push(_)}}R&&Bu(this)},render:function(t,e){if(e.tween._time||!Eo())for(var n=e._pt;n;)n.r(t,n.d),n=n._next;else e.styles.revert()},get:wn,aliases:dn,getSetter:function(t,e,n){var i=dn[e];return i&&i.indexOf(",")<0&&(e=i),e in Un&&e!==Ne&&(t._gsap.x||wn(t,"x"))?n&&lc===n?e==="scale"?D0:L0:(lc=n||{})&&(e==="scale"?U0:I0):t.style&&!oo(t.style[e])?C0:~e.indexOf("-")?P0:xo(t,e)},core:{_removeProperty:Si,_getMatrix:To}};Fe.utils.checkPrefix=rr;Fe.core.getStyleSaver=Vu;(function(r,t,e,n){var i=Ue(r+","+t+","+e,function(s){Un[s]=1});Ue(t,function(s){We.units[s]="deg",Yu[s]=1}),dn[i[13]]=r+","+t,Ue(n,function(s){var a=s.split(":");dn[a[1]]=i[a[0]]})})("x,y,z,scale,scaleX,scaleY,xPercent,yPercent","rotation,rotationX,rotationY,skewX,skewY","transform,transformOrigin,svgOrigin,force3D,smoothOrigin,transformPerspective","0:translateX,1:translateY,2:translateZ,8:rotate,8:rotationZ,8:rotateZ,9:rotateX,10:rotateY");Ue("x,y,z,top,right,bottom,left,width,height,fontSize,padding,margin,perspective",function(r){We.units[r]="px"});Fe.registerPlugin(Zu);var $u=Fe.registerPlugin(Zu)||Fe;$u.core.Tween;const gc=document.getElementById("loading-screen"),X0=document.getElementById("loading-canvas"),bo=new Zc,As=new Pe(75,window.innerWidth/window.innerHeight,.1,1e3);As.position.z=5;const Ao=new ro({canvas:X0,antialias:!0});Ao.setSize(window.innerWidth,window.innerHeight);const q0=new so(1,32,32),Y0=new Ag({color:16755200,roughness:.3,metalness:.8}),Za=new Pn(q0,Y0);bo.add(Za);const Ju=new Pg(16777215,1);Ju.position.set(5,5,5);bo.add(Ju);function Qu(){requestAnimationFrame(Qu),Za.rotation.x+=.01,Za.rotation.y+=.01,Ao.render(bo,As)}Qu();setTimeout(()=>{$u.to(gc,{opacity:0,duration:1,onComplete:()=>{gc.classList.add("hidden"),$0()}})},4e3);const j0=document.getElementById("main-content"),K0=document.getElementById("starfield-canvas"),th=new Zc,ws=new Pe(75,window.innerWidth/window.innerHeight,1,1e3);ws.position.z=1;const Fs=new ro({canvas:K0,antialias:!0});Fs.setSize(window.innerWidth,window.innerHeight);Fs.setClearColor(0,1);const eh=new gn,nh=[];for(let r=0;r<1e3;r++){const t=js.randFloatSpread(600),e=js.randFloatSpread(600),n=js.randFloatSpread(600);nh.push(t,e,n)}eh.setAttribute("position",new ln(nh,3));const Z0=new $c({color:16777215}),$a=new bg(eh,Z0);th.add($a);function ih(){requestAnimationFrame(ih),$a.rotation.x+=5e-4,$a.rotation.y+=5e-4,Fs.render(th,ws)}function $0(){j0.classList.remove("hidden"),ih()}const J0=document.getElementById("dark-mode-toggle"),Rs=document.documentElement;localStorage.getItem("darkMode")==="true"||!localStorage.getItem("darkMode")&&window.matchMedia("(prefers-color-scheme: dark)").matches?Rs.classList.add("dark"):Rs.classList.remove("dark");J0.addEventListener("click",()=>{Rs.classList.toggle("dark"),localStorage.setItem("darkMode",Rs.classList.contains("dark"))});document.getElementById("btn-about").addEventListener("click",()=>{alert("Navigiere zu 'Über mich'")});document.getElementById("btn-skills").addEventListener("click",()=>{alert("Navigiere zu 'Skills'")});document.getElementById("btn-projects").addEventListener("click",()=>{alert("Navigiere zu 'Projekte'")});document.getElementById("btn-contact").addEventListener("click",()=>{alert("Navigiere zu 'Kontakt'")});window.addEventListener("resize",()=>{As.aspect=window.innerWidth/window.innerHeight,As.updateProjectionMatrix(),Ao.setSize(window.innerWidth,window.innerHeight),ws.aspect=window.innerWidth/window.innerHeight,ws.updateProjectionMatrix(),Fs.setSize(window.innerWidth,window.innerHeight)});
